...
- Building AI tooling, luthiery tools, and reproducible 3D print pipelines
- Ask me about MCP servers, build123d, string instruments, tin whistles, Irish music
...
- [purfroller](https://github.com/pzfreo/purfroller) — parametric purfling roller for instrument making
- [Teleclaude](https://github.com/pzfreo/Teleclaude) — Claude Code via Telegram

**Luthiery blog:** [paulfremantleluthier.substack.com](https://paulfremantleluthier.substack.com/)
